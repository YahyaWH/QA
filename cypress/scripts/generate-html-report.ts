...
<div class="container">
  <header class="report-header">
    <div><h1>Cypress Test Report <span>— Finance Tracker</span></h1></div>
  ...
  <footer class="report-footer">
    Generated by Cypress HTML Reporter &middot; Finance Tracker E2E Tests &middot; ${escapeHtml(dateStr)} at ${escapeHtml(timeStr)}
  </footer>
</div>
